 ...
 * inyecta aqui, sin que lo sepamos, AlumnoRepositoryBinarioImpl en lugar
 * del antiguo AlumnoRepositoryImpl). La UNICA adaptacion necesaria esta en
 * {@link #inicializarDatosSemilla()}, justo porque ahora los datos SI
...
public class AlumnoServiceImpl implements AlumnoService {
     ...
     * siempre vacio. Ahora que el repositorio persiste en un fichero
     * binario, los datos SI sobreviven entre ejecuciones, asi que hay
     * que cargar la semilla solo la primera vez (repositorio vacio); en
     * caso contrario duplicariamos los alumnos de ejemplo en cada
